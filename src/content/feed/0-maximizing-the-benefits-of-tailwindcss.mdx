...
slug: maximizing-the-benefits-of-tailwindcss
tags: [react, tailwindcss]
topic: web
draft: false
---
import {components} from "../../components/markdown/index.tsx";
export { components };
...
![a screenshot of a Guillermo Rauch tweet saying: "Tailwind thoroughly fixes CSS, by removing: Naming paralysis, Cascade side effects, Module import indirection, Declaration order side effects, Ergonomics](./_0/rauch-tweet.png)
...
![A tweet from Adam Wathan that `@apply` brings many problems to the team, while `theme` syntax seem so much better](./_0/adam-tweet.png)
