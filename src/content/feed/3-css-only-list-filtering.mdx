...
I did something bad that I won’t recommend but I’m excited to share it.

## Self-inflicted problem (as many are)

I used to ship my personal website to [Vercel](https://vercel.com/), which has generous free plan. However, I always wanted to use [Cloudflare](https://www.cloudflare.com/), especially if I plan to buy the domain there. They also have quite a good free offering.
...
As I switched from Vercel to Cloudflare, I immediately noticed the major problem: my images are not optimised. [astro:assets](https://docs.astro.build/en/guides/images/) provide image optimisations using Sharp, and Cloudflare adapter does not support it. So, I was left with the choice of:
